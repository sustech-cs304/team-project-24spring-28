...
import MapContainer from "@/components/old/Student/pages/FindRoom/map/MapContainer.vue";
import briefRoomInfo from "@/components/old/Student/pages/FindRoom/briefRoomInfo.vue";
