...
import BulletinCard from "@/components/Student/pages/StudentEnd/bulletin/BulletinCard.vue";
import BriefStudentInfo from "@/components/Student/pages/Bulletin/briefStudentInfo.vue";
