...
import NoticeEntity from "@/components/Student/pages/Message/NoticeEntity.vue";
import Avatar from "@/components/Student/Avatar.vue";
import Chat from "@/components/Student/pages/Message/chat/Chat.vue";
import CommentEntity from "@/components/Student/pages/Message/CommentEntity.vue";
import {formatTime} from "@/components/Student/pages/Message/utils";
import Invitation from "@/components/Student/pages/Message/Invitation/Invitation.vue";
import Exchange from "@/components/Student/pages/Message/exchange/Exchange.vue";
